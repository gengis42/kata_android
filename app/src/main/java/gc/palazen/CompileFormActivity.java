...
public class CompileFormActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        OnClickListener changeValueDisablePreviousAndNextPlusUpdateTotalScore = new View.OnClickListener() {
			public void onClick(View v) {
	        	...
	        	//stampo il totale
	        	tvTotal.setText(calculateScoreFromPenality(p1.isChecked(), p2.isChecked(), p3.isChecked(), p4.isChecked(), p5.isChecked()) + "");
			}
        };
	...
	private void compilePreviousForm()
	{
        ...
        //stampo il totale
        tvTotalP.setText(calculateScoreFromPenality(p1p.isChecked(), p2p.isChecked(), p3p.isChecked(), p4p.isChecked(), p5p.isChecked()) + "");
	}
	private void compileNextForm()
	{
        ...
        //stampo il totale
        tvTotalN.setText(calculateScoreFromPenality(p1n.isChecked(), p2n.isChecked(), p3n.isChecked(), p4n.isChecked(), p5n.isChecked()) + "");
	}
	...
	private int calculateScoreFromPenality(boolean c1, boolean c2,boolean c3,boolean c4,boolean c5)
	{
		int total=10;
    	if(c1)
    		total -= 1;
